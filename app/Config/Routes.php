...
$routes->group('/TrainingSchool', ['filter' => 'TrainingSchool'], function ($routes) {
    ...
    $routes->post('formerEmployee/reactiveKaryawan', 'TrainingSchoolController::reactiveKaryawan');
...
$routes->group('/Absensi', ['filter' => 'Absensi'], function ($routes) {
    ...
    $routes->get('excelJamKerja', 'ShiftController::excelJamKerja');
...
$routes->group('api', function ($routes) {
    ...
    $routes->get('getdataforbs/(:any)', 'ApiController::getDataForBsMc/$1');
    $routes->get('getEmployeeByName/(:segment)', 'ApiController::getEmployeeByName/$1');
    $routes->get('penilaian/chart-data', 'ApiController::chartData');
});
