    ...
    <div class="collapse navbar-collapse h-auto w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3  ">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-10">Data</h6>
            </li>
            <!-- User -->
            <!-- <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $title == 'Bagian' ? 'active' : '' ?>"
                    ...
                    <span class="nav-link-text ms-1">Bagian</span>
                </a>
            </li>
            <!-- Karyawan -->
            <li class="nav-item">
                        ...
                        <svg class="text-dark" width="16px" height="16px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Rounded-Icons" transform="translate(-1717.000000, -291.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g id="Icons-with-opacity" transform="translate(1716.000000, 291.000000)">
                                        <g id="employee-data" transform="translate(1.000000, 0.000000)">
                                            <path class="color-background" d="M45,0 L26,0 C25.447,0 25,0.447 25,1 L25,20 C25,20.379 25.214,20.725 25.553,20.895 C25.694,20.965 25.848,21 26,21 C26.212,21 26.424,20.933 26.6,20.8 L34.333,15 L45,15 C45.553,15 46,14.553 46,14 L46,1 C46,0.447 45.553,0 45,0 Z" id="Path" opacity="0.6"></path>
            ...
            <li class="nav-item">
                <a class="nav-link <?= $title == 'Job Role' ? 'active' : '' ?>"
                    ...
                    <span class="nav-link-text ms-1">Job Role</span>
                </a>
            </li>
            <!-- Absen -->
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $title == 'Former Karyawan' ? 'active' : '' ?>"
                    href="<?= base_url('Monitoring/formerKaryawan') ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <hr class="horizontal dark mt-3 mb-1">
            <li class="nav-item mt-3  ">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-10">Summary DATA</h6>
            </li>
            <!-- summary data -->
            <!-- bsmc -->
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $title == 'Jarum' ? 'active' : '' ?>"
                    ...
                    <span class="nav-link-text ms-1">Jarum</span>
                </a>
            </li>
            <hr class="horizontal dark mt-3 mb-1">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $title == 'Report Batch' ? 'active' : '' ?>"
                    ...
                    <span class="nav-link-text ms-1">Report Batch</span>
                </a>
            </li>
